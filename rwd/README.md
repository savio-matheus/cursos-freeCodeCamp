...
## Formulário simples
<p align="center"><img alt="Visualização da página do formulário, contendo um título, descrição e parte seção com os campos." src="img/2_pagina_formulario.png" width="60%"></p>
